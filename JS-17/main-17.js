...
let weight = Number(prompt("Укажите вес вашей посылки (в кг)"));
let type = prompt("Напишите тип доставки посылки: Стандарт, Экспресс, Премиум")
